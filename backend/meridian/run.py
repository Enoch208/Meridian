...
def pick_to_response(p: Pick) -> PickResponse:
    ...
    return PickResponse(
        ...
        token=TokenInfo(
            ...
            website=p.candidate.website,
            twitter=p.candidate.twitter,
            telegram=p.candidate.telegram,
        ),
        ...
        metrics=TokenMetrics(
            ...
            fdv=p.candidate.fdv,
            market_cap=p.candidate.market_cap,
            age_hours=p.candidate.age_hours,
            volume_h24=p.candidate.volume_h24,
            buy_sell_ratio_h1=p.candidate.buy_sell_ratio_h1(),
            buys_h1=p.candidate.buys_h1,
            sells_h1=p.candidate.sells_h1,
            holder_count=p.candidate.holder_count,
            top_holders_pct=p.candidate.top_holders_pct,
            dev_holding_pct=p.candidate.dev_holding_pct,
            organic_score=p.candidate.organic_score,
            dev_wallet=p.candidate.dev_wallet,
            price_usd=p.candidate.price_usd,
            price_change_24h=p.candidate.price_change_24h,
            launchpad=p.candidate.launchpad,

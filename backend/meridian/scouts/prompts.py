...
LEAD_PROMPT = (
    ...
    "SMART MONEY: A deterministic smart-money scout runs separately and may "
    "be overlaid on your output after you respond. Leave scores.smart_money as "
    "null in your JSON — the system will fill it from the watchlist if data is "
    "available; if not, it remains null and 'smart_money' appears in the "
    "pick's unknowns list. Never invent or estimate a smart_money score.\n\n"
    "COMPOSITE SCORING:\n"
